...
public class AdminFragment extends Fragment {
    private static AdminFragment instance;
    ...
    //region Instance
    public static AdminFragment Instance()
    {
        if (instance == null)
        {
    ...
    private void Instance(AdminFragment instance)
    {
        AdminFragment.instance = instance;
    }
    //endregion
    ...
    public void Insert()
    {
        AlertDialog.Builder alerDialog = new AlertDialog.Builder(AdminFragment.this.getContext(),android.R.style.Theme_Light_NoTitleBar_Fullscreen);
        ...
        alerDialog.setNegativeButton("Insert", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                accountDAO.Instance(AdminFragment.this.getContext()).InsertAccount(newAccount);
                adminAdapter.AddItem(newAccount);

                // Insert Location
                locationDAO.Instance(AdminFragment.this.getContext()).InsertLocation("No Name");
                // ----------------

                // Insert Store
                int idLocationMax = locationDAO.Instance(AdminFragment.this.getContext()).getMaxLocationID();
                if(idLocationMax != -1)
                {
                    storeDAO.Instance(AdminFragment.this.getContext()).InsertStore("No Name", idLocationMax, etUserName.getText().toString());
                }
                // -----------------------------
            }
        });
